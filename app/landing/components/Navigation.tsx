      ...
      <div className="w-full mx-auto px-8 max-w-7xl lg:px-16">
        <div className="relative flex flex-col w-full py-5 mx-auto lg:items-center lg:justify-between lg:flex-row lg:px-6">
          <div className="flex flex-row items-center justify-between lg:justify-start">
            <Link href="/landing" className="text-black inline-flex items-center gap-2">
          ...
          <nav
            id="main-navigation"
            className={`flex-col items-center flex-grow gap-4 lg:gap-8 flex overflow-hidden lg:pb-0 lg:flex lg:justify-end lg:flex-row ${open ? 'h-auto' : 'h-0'} lg:h-auto`}>
            <div className="inline-flex items-center gap-2 list-none py-px lg:ml-auto">
              <a
                ...
                className="btn-secondary flex items-center justify-center h-8 px-4 py-2 text-xs font-medium rounded-md">
                Get in touch
              </a>
            </div>
          </nav>
