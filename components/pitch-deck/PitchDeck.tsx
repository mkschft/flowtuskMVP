        ...
        <div className="grid grid-cols-5 gap-8">
          ...
          <div className="col-span-2 flex items-center">
            <div className="w-full h-full min-h-[300px] rounded-xl overflow-hidden">
              <Image
                src="/problem.png"
                alt="Positioning Chaos - Activity feed showing scattered notifications and tool chaos"
                width={600}
                height={400}
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-xl font-semibold text-foreground">Content AI is commoditized</h3>
            </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-xl font-semibold text-foreground">The gap (what&apos;s missing)</h3>
            </div>
            <p className="text-sm text-muted-foreground">
        ...
        <div className="grid grid-cols-5 gap-8">
          ...
          <div className="col-span-3 space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <Card className="p-4 bg-gradient-to-br from-violet-50/30 to-purple-50/30 dark:from-violet-950/10 dark:to-purple-950/10">
                <div className="space-y-2">
                  <span className="text-3xl text-[#7c3aed] shrink-0 font-bold block">€</span>
              ...
              <Card className="p-4 bg-gradient-to-br from-violet-50/30 to-purple-50/30 dark:from-violet-950/10 dark:to-purple-950/10">
                <div className="space-y-2">
                  ...
                  <p className="text-lg font-bold text-foreground leading-tight">
                    <span className="gradient-text">50+</span> conversion points
                  </p>
                  <p className="text-xs text-muted-foreground">
            ...
            <div className="space-y-4">
              <Card className="p-6 bg-gradient-to-br from-violet-50/50 to-purple-50/50 dark:from-violet-950/20 dark:to-purple-950/20 border border-purple-200/50 dark:border-purple-800/30">
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-muted-foreground font-semibold">Enterprise Agency Partner, Helsinki</p>
                </div>
              </Card>
              ...
              <Card className="p-6 bg-gradient-to-br from-violet-50/50 to-purple-50/50 dark:from-violet-950/20 dark:to-purple-950/20 border border-purple-200/50 dark:border-purple-800/30">
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-muted-foreground font-semibold">Digital Agency Partner, London</p>
                </div>
              </Card>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-12">
            ...
            <div className="space-y-3">
                    ...
                    <div className="flex-1 flex flex-col items-center h-full justify-end">
                      <div className="w-full flex flex-col items-center h-full justify-end relative">
                        <div 
                          ...
                          style={{ height: '32px' }}
                        />
                        <p className="text-xs font-bold text-foreground mb-1">2026 (Foundation)</p>
                        <p className="text-sm font-bold gradient-text mb-1">€60K ARR</p>
                      </div>
                    </div>
                    ...
                    <div className="flex-1 flex flex-col items-center h-full justify-end">
                      <div className="w-full flex flex-col items-center h-full justify-end relative">
                        <div 
                          ...
                          style={{ height: '110px' }}
                        />
                        <p className="text-xs font-bold text-foreground mb-1">2027 (Scale)</p>
                        <p className="text-sm font-bold gradient-text mb-1">€1M ARR</p>
                      </div>
                    </div>
                    ...
                    <div className="flex-1 flex flex-col items-center h-full justify-end">
                      <div className="w-full flex flex-col items-center h-full justify-end relative">
                        <div 
                          ...
                          style={{ height: '200px' }}
                        />
                        <p className="text-xs font-bold text-foreground mb-1">2028+ (Growth)</p>
                        <p className="text-sm font-bold gradient-text mb-1">€5M+ ARR</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <Card className="p-4 bg-gradient-to-br from-violet-50/50 to-purple-50/50 dark:from-violet-950/20 dark:to-purple-950/20 border border-purple-200/50 dark:border-purple-800/30 mt-4">
                <div className="space-y-2">
                  <p className="text-xs font-semibold text-foreground uppercase tracking-wide mb-2">Revenue Model</p>
                  <div className="grid grid-cols-5 gap-4">
                    {/* Left Column - Pricing Tiers */}
                    <div className="col-span-3 space-y-1.5 text-xs text-muted-foreground">
                      <p>
                        <span className="font-semibold text-foreground">Basic:</span> €49/mo (indie founders, SMBs)
                      </p>
                      <p>
                        <span className="font-semibold text-foreground">Advanced:</span> €149/mo (agencies, growth teams)
                      </p>
                      <p>
                        <span className="font-semibold text-foreground">Premium:</span> €249/mo (enterprise, white-label)
                      </p>
                    </div>
                    {/* Right Column - Metrics */}
                    <div className="col-span-2 space-y-1.5 text-xs text-muted-foreground">
                      <p>
                        <span className="font-semibold text-foreground">Avg. ARPU:</span> <span className="gradient-text font-bold">€119/mo</span>
                      </p>
                      <p>
                        <span className="font-semibold text-foreground">Est. Customer LTV:</span> <span className="gradient-text font-bold">€1,800</span>
                      </p>
                      <p>
                        <span className="font-semibold text-foreground">Target CAC:</span> <span className="gradient-text font-bold">€500-800</span>
                      </p>
                    </div>
                  </div>
                </div>
    ...
    <Slide slideNumber={10} tag="Go-to-market">
      <div className="space-y-8">
          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-semibold gradient-text">First 6-months GTM Targets</h3>
              <div className="grid grid-cols-2 gap-4">
          ...
          <div className="relative">
            ...
            <Card className="p-6 bg-gradient-to-br from-violet-200 to-purple-200 dark:from-violet-900/50 dark:to-purple-900/50 min-h-[240px] flex flex-col justify-center relative border-2 border-purple-600 dark:border-purple-500">
              <div className="space-y-4 flex flex-col items-center">
                ...
                <h3 className="text-2xl font-semibold gradient-text">Flowtusk</h3>
        ...
        <div className="grid grid-cols-5 gap-12">
          ...
          <div className="col-span-2 space-y-4">
            ...
            <div className="text-center space-y-1">
              <h3 className="text-xl font-semibold text-foreground">Hasan Shahriar</h3>
          ...
          <div className="col-span-3 space-y-6">
            {/* Title */}
            <h3 className="text-xl font-semibold gradient-text">8+ Years of B2B Marketing and GTM Expertise—Productized</h3>
    ...
    <Slide slideNumber={11} tag="The Ask">
      <div className="space-y-12">
        ...
        <div className="grid grid-cols-5 gap-12">
          ...
          <div className="col-span-3 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <Card className="p-4 bg-muted/30">
                <p className="text-sm text-muted-foreground">
                  to turn agency expertise into a GenAI positioning platform<br />
            ...
            {/* Use of Funds */}
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-foreground">Use of Funds</h3>
            ...
            <Card className="p-4 bg-gradient-to-br from-violet-50/50 to-purple-50/50 dark:from-violet-950/20 dark:to-purple-950/20 border border-purple-200/50 dark:border-purple-800/30">
              <div className="space-y-2">
                <p className="text-xs font-semibold text-foreground uppercase tracking-wide mb-2">Team Build-Out</p>
                <div className="space-y-1.5 text-xs text-muted-foreground">
                  <p>
                    <span className="font-semibold text-foreground">Core hires:</span> AI/LLM Engineer (€78K), Full Stack Developer (€60K), Content Marketer (€24K). Founder manages product, GTM, and agency partnerships. <span className="font-semibold text-foreground">External support:</span> Development contractors (€16K), cloud (€10.5K)
                  </p>
                </div>
              </div>
            </Card>
          ...
          <div className="col-span-2 space-y-4">
            <h3 className="text-xl font-semibold gradient-text">Why This Partnership Works</h3>
            ...
            <div className="space-y-3">
              <Card className="p-4">
                <div className="flex gap-3">
                  ...
                  <div className="space-y-1.5 flex-1">
                    <h4 className="text-base font-semibold text-foreground">Reduced risk for Nordea</h4>
                    <p className="text-sm text-muted-foreground">
              ...
              <Card className="p-4">
                <div className="flex gap-3">
                  <div className="w-2 h-2 rounded-full bg-gradient-to-br from-[#7c3aed] to-[#8b5cf6] mt-1 shrink-0" />
                  <div className="space-y-1.5 flex-1">
                    <h4 className="text-base font-semibold text-foreground">Strategic for Flowtusk</h4>
                    <p className="text-sm text-muted-foreground">
              ...
              <Card className="p-4">
                <div className="flex gap-3">
                  <div className="w-2 h-2 rounded-full bg-gradient-to-br from-[#7c3aed] to-[#8b5cf6] mt-1 shrink-0" />
                  <div className="space-y-1.5 flex-1">
                    <h4 className="text-base font-semibold text-foreground">Mutual value creation</h4>
                    <p className="text-sm text-muted-foreground">
              ...
              <Card className="p-4">
                <div className="flex gap-3">
                  <div className="w-2 h-2 rounded-full bg-gradient-to-br from-[#7c3aed] to-[#8b5cf6] mt-1 shrink-0" />
                  <div className="space-y-1.5 flex-1">
                    <h4 className="text-base font-semibold text-foreground">Personal connection</h4>
                    <p className="text-sm text-muted-foreground">
...
export function PitchDeck() {
  ...
  return (
    <div className={`relative w-full h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-950 dark:to-purple-950 overflow-hidden ${varelaRound.className}`}>
