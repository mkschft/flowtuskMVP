...
export function EmailSequenceCard({ data, personaTitle }: EmailSequenceCardProps) {
  ...
  const emailTypeColors = {
    ...
    'final-ask': { gradient: 'from-amber-500 to-yellow-500', bg: 'bg-amber-100 dark:bg-amber-950', text: 'text-amber-700 dark:text-amber-300', border: 'border-amber-300 dark:border-amber-700' }
  };
