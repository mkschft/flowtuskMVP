/**
 * MemoryManager - Manages conversation memory with localStorage persistence
 * Tracks action history and dependencies
 */

import type { ConversationMemory } from "@/app/app/types";
